    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_image",
                    models.FileField(
                        blank=True, null=True, upload_to="Product_images/%Y%m%d/%H%M%S/"
                    ),
                ),
                ...
                (
                    "is_delete",
                    models.CharField(
                        choices=[("0", "No"), ("1", "Yes")], default="0", max_length=10
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "register_by",
                    models.CharField(default="self", max_length=255, null=True),
                ),
                (
                    "is_approved",
                    models.CharField(
